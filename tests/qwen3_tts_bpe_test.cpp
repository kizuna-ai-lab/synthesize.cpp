...
constexpr const char * kSplit1[] = { "It", "'s", " a", " test", ",", " isn", "'t", " it", "?", " I", "'d", " say", " we", "'ve", " won", "." };
constexpr const char * kSplit2[] = { "Numbers", " ", "1", "2", "3", "4", " and", " ", "5", ".", "6", "7", " do", " not", " group", "." };
constexpr const char * kSplit3[] = { " ", " leading", " and", " trailing", "   " };
constexpr const char * kSplit4[] = { "line", " one", "\x0a" "", "line", " two", "\x0d" "\x0a" "", "line", " three", "\x0a" "\x0a" "" };
constexpr const char * kSplit5[] = { "punctuation", "!!!", " ...---", " ???" };
constexpr const char * kSplit6[] = { "\xe4" "\xbd" "\xa0" "\xe5" "\xa5" "\xbd" "", "\xef" "\xbc" "\x8c" "\xe4" "\xb8" "\x96" "\xe7" "\x95" "\x8c" "", "\xe3" "\x80" "\x82" "\xe8" "\xbf" "\x99" "\xe6" "\x98" "\xaf" "\xe4" "\xb8" "\x80" "\xe4" "\xb8" "\xaa" "\xe6" "\xb5" "\x8b" "\xe8" "\xaf" "\x95" "", "\xe3" "\x80" "\x82" "" };
constexpr const char * kSplit7[] = { "\xe3" "\x81" "\x93" "\xe3" "\x82" "\x93" "\xe3" "\x81" "\xab" "\xe3" "\x81" "\xa1" "\xe3" "\x81" "\xaf" "", "\xe3" "\x80" "\x81" "\xe4" "\xb8" "\x96" "\xe7" "\x95" "\x8c" "", "\xe3" "\x80" "\x82" "" };
constexpr const char * kSplit8[] = { "\xec" "\x95" "\x88" "\xeb" "\x85" "\x95" "\xed" "\x95" "\x98" "\xec" "\x84" "\xb8" "\xec" "\x9a" "\x94" "" };
constexpr const char * kSplit9[] = { "Emoji", " \xf0" "\x9f" "\x98" "\x80" "", " and", " \xc3" "\xa9" "\xc3" "\xa8" "\xc3" "\xaa" "", " accents" };
constexpr const char * kSplit10[] = { "<|", "im", "_start", "|>", "assistant", "\x0a" "", "Hello", ".<|", "im", "_end", "|>\x0a" "", "<|", "im", "_start", "|>", "assistant", "\x0a" "" };
...
constexpr SplitCase kSplitCases[] = {
    ...
    { "line one\x0a" "line two\x0d" "\x0a" "line three\x0a" "\x0a" "", kSplit4, 9 },
    { "punctuation!!! ...--- ???", kSplit5, 4 },
    { "\xe4" "\xbd" "\xa0" "\xe5" "\xa5" "\xbd" "\xef" "\xbc" "\x8c" "\xe4" "\xb8" "\x96" "\xe7" "\x95" "\x8c" "\xe3" "\x80" "\x82" "\xe8" "\xbf" "\x99" "\xe6" "\x98" "\xaf" "\xe4" "\xb8" "\x80" "\xe4" "\xb8" "\xaa" "\xe6" "\xb5" "\x8b" "\xe8" "\xaf" "\x95" "\xe3" "\x80" "\x82" "", kSplit6, 4 },
    { "\xe3" "\x81" "\x93" "\xe3" "\x82" "\x93" "\xe3" "\x81" "\xab" "\xe3" "\x81" "\xa1" "\xe3" "\x81" "\xaf" "\xe3" "\x80" "\x81" "\xe4" "\xb8" "\x96" "\xe7" "\x95" "\x8c" "\xe3" "\x80" "\x82" "", kSplit7, 3 },
    { "\xec" "\x95" "\x88" "\xeb" "\x85" "\x95" "\xed" "\x95" "\x98" "\xec" "\x84" "\xb8" "\xec" "\x9a" "\x94" "", kSplit8, 1 },
    { "Emoji \xf0" "\x9f" "\x98" "\x80" " and \xc3" "\xa9" "\xc3" "\xa8" "\xc3" "\xaa" " accents", kSplit9, 5 },
    { "<|im_start|>assistant\x0a" "Hello.<|im_end|>\x0a" "<|im_start|>assistant\x0a" "", kSplit10, 17 },
    { "", kSplit11, 0 },
    { " ", kSplit12, 1 },
};
...
int check_frontend() {
    ...
    config.vocab            = { "a", "b", "c", kSpace, std::string(kSpace) + "a", "ab",
                                std::string(kSpace) + "ab", "<|im_start|>", "<|im_end|>", "\n" };
    ...
    config.special_tokens   = { { "<|im_start|>", 7 }, { "<|im_end|>", 8 } };
...
int check_configuration_rejections() {
    ...
    negative.vocab            = { "a" };
    negative.special_tokens   = { { "<|im_start|>", -1 } };
